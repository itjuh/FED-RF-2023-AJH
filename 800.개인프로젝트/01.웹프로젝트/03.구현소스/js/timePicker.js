const timePickerSetting = () => {
  ...
  const timeList = document.querySelector(".time-slider-wraper li");
  const moveDistance = timeList.getBoundingClientRect().height;
  ...
  console.log(timeList.getBoundingClientRect().height,"ampmInitPos", ampmInitPos, "hourInitPos", hourInitPos, "minInitPos", minInitPos);
