...
// 1단계 : 데이터 매핑하기
dFn.addEvt(sel5,'change',()=>{
    targetData = newList3;
});
dFn.addEvt(cta5,'change',()=>{
    targetData = newList3;
});
// 2단계 : change이벤트 설정하기
dFn.addEvt(sel5,'change',sortingFn);
dFn.addEvt(cta5,'change',sortingFn);

// 3단계 : 검색기준 선택박스 변경 시 변경기준 초기화 하기
