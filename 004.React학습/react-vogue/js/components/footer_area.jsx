// VOGUE 하단영역 컴포넌트 - footer_area.jsx

//////////// 하단영역 컴포넌트 ////////////////////
/************************************************ 
  컴포넌트명 : FooterArea
  기능 : 하단영역 링크메뉴, 회사정보 구성
************************************************/
export default function FooterArea() {
  console.log("하단영역 실행");

  // 상태관리변수 : 하단 변경여부 저장 변수
...
// 만약 전달값 props가 없으면 없는 상태가 계속 유지되므로
// 재활용 없이 다시 컴포넌트가 그려지는 일은 없다(중복실행 막기)
