...
class Gogh extends React.Component{
    // 리액트컴포넌트를 상속받아서 클래스를 구현해서 사용할거다
    
    // render() 메서드를 사용하여 리턴함
    render(){
        //html태그 리턴
        return(
            <React.Fragment>
...
ReactDOM.render(<Favorite color="보라색" food="고기" hobby="게임" />,document.querySelector('#root3'));

// [ 컴포넌트 재사용하기 ]
ReactDOM.render(<Favorite color="노란색" food="라면" hobby="야구" />,document.querySelector('#root4'));

// [ 컴포넌트 내부에서 다른 컴포넌트 출력하기 ]
function Who(){
    return(
        <div>
            <h1>김똑팔이가 누구야?</h1>
